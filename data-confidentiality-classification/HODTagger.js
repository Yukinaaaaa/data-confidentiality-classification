function tagHOFields() {
    ...
    fs.readFile('homeowners.json', 'utf8', (err, data) => {
        ...
        for (let i = 0; i < customers.length; i++){
            ...
            for (var key in obj) {
                ...
                if (key.search("employer") != -1) {
                    var employer_value = value + "-qsi-demographic";
                }
                if (key.search("employmentstatus") != -1) {
                    var employmentstatus_value = value + "-qsi-demographic";
                }
                if (key.search("payslip") != -1) {
                    var payslip_value = value + "-qsi-financial";
                }
                ...
                if (key.search("yearlyenergycost") != -1) {
                    var yearlyenergycost_value = value + "-qsi-house";
                }
                ...
                if (key.search("fullname") != -1) {
                    var fullname_value = value + "-hsi-demographic";
                }
                ...
                if (key.search("disabilityallowance") != -1) {
                    var disabilityallowance_value = value + "-qsi-financial";
                }
                ...
                if (key.search("spousalmaintenanceincome") != -1) {
                    var spousalmaintenanceincome_value = value + "-qsi-financial";
                }
        ...
        fs.writeFile("taggedhomeowners.json", JSON.stringify(saved), (err) => {
        });
